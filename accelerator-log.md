...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"default","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1308005896545104126, --data-values-file, /tmp/accelerator-options14787665920413492684.json, --output-files, /tmp/ytt-output3331490405101050469]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"default","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input5465612405903134013, --data-values-file, /tmp/accelerator-options979071195427504256.json, --output-files, /tmp/ytt-output3015072289400105739]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","devDefaultAccountPassword":"letseat","appSSOIssuerURI":"http://authserver.<domainname>","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","createResourceClaim":true,"numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"default","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input17259742721284365558, --data-values-file, /tmp/accelerator-options3064514980201015321.json, --output-files, /tmp/ytt-output6561210075236537742]
